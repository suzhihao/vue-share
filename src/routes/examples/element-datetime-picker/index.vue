...
<div class="row">
  <p>在同一个选择器里选择日期和时间</p>
  <p>DateTimePicker 由 DatePicker 和 TimePicker 派生，Picker Options 或者其他选项可以参照 DatePicker 和 TimePicker。</p>
  <br/>
  <div class="col-md-24">
    <h3>日期和时间点</h3>
    <div class="block">
    ...
    <br/><br/>
    <p>event事件: change：用户确认选定的值时触发</p>
    <p>event事件: blur：当 input 失去焦点时触发</p>
    <p>event事件: focus：当 input 获得焦点时触发</p>
  </div>
</div>
</div>
</template>
